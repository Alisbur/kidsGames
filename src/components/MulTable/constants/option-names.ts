...
export const SHOULD_SHUFFLE_EXAMPLES_OPTIONS_NAMES: Record<SHOULD_SHUFFLE_EXAMPLES_ENUM, string> = {
  [SHOULD_SHUFFLE_EXAMPLES_ENUM.YES]: "Да",
  [SHOULD_SHUFFLE_EXAMPLES_ENUM.NO]: "Нет",
};
